...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $_SESSION['message'] = 'An error occurred. Check logs for details.';
...
<div class="container mt-4">
    ...
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>Followups</h5>
            <button class="btn btn-success btn-custom" data-bs-toggle="modal" data-bs-target="#addFollowupModal">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-sm btn-primary btn-custom" data-bs-toggle="modal" 
                                                data-bs-target="#editFollowupModal" 
                                                data-followupid="<?= $followup['id'] ?>"
                                                data-currentstatus="<?= $followup['status'] ?>">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger btn-custom" data-bs-toggle="modal" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    editModal.addEventListener('show.bs.modal', function(event) {
        ...
        console.log('Edit Modal opened for ID:', followupId, 'with status:', currentStatus); // Debug log
    });
    ...
    deleteModal.addEventListener('show.bs.modal', function(event) {
        ...
        console.log('Delete Modal opened for ID:', followupId); // Debug log
    });
